...
#define stack_dump(output_file, Stack, mode) \
                          stack_dump_(output_file, Stack, mode, __FUNCTION__, __FILE__, __LINE__)
...
enum CANARIES
{
    LEFT_DATA_CANARY  = 0xBAAD,
    RIGHT_DATA_CANARY = 0xDEAD,
    LEFT_CANARY       = 0xFAAD,
    RIGHT_CANARY      = 0x0BAD,
};
